...
To learn more about how these locales are generated in Bullet Train, see the documentation on [Bullet Train's Super Scaffolding](../super-scaffolding.md)
...
We recommend firing up a Bullet Train project and using its `bin/resolve` (see docs on [Indirection](../indirection.md)) to get a copy of the partial field locally to modify.
