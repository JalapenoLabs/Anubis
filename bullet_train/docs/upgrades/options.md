...
* [The YOLO Method (The original upgrade method)](yolo.md)
* [The Stepwise Method - For `1.4.0` and above](../upgrades.md)
* [Upgrade from any version to `1.4.0`](yolo-140.md)
* [Upgrade from any version to `1.3.0`](yolo-130.md)
* [Upgrade from `1.3.x` to `1.4.0`](yolo-140.md)
* [Notable versions](notable-versions.md)
...
[Be sure to check our Notable Versions list to see if there's anything tricky about the version you're moving to.](notable-versions.md)
...
[Read more about The YOLO Method](yolo.md)
...
[Read more about The Stepwise Method](../upgrades.md)
...
[Read more about going directly to `1.4.0`](yolo-140.md)
...
[Read more about going directly to `1.3.0`](yolo-130.md)
...
[Read more about going from `1.3.x` to `1.4.0`](yolo-140.md)
