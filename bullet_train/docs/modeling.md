...
Domain modeling is one of the most important activities in software development. With [Super Scaffolding](super-scaffolding.md), it's also one of the highest leverage activities in Bullet Train development.
...
See the [Super Scaffolding documentation](super-scaffolding.md) for more specific guidance. Leave plenty of comments in your scratch file describing anything that isn't obvious and providing examples of values that might populate attributes.
