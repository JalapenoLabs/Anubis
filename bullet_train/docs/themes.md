...
If you're building custom components that need to respond to color scheme changes, see [Responding to Color Scheme Changes](javascript.md#responding-to-color-scheme-changes) in the JavaScript documentation.
...
* [Installing Bullet Train Themes on Other Rails Projects](themes/on-other-rails-projects.md)
* [Installing Bullet Train Themes on Jumpstart Pro Projects](themes/on-jumpstart-pro-projects.md)
