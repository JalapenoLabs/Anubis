...
> Really loving the PR for Rails 6.1's Delegated Types. From the application developer level, very little of it feels "new". Instead, the experience reads very similar to what many of us were already doing with the existing tools, but even smoother! [https://t.co/6UkxXNCvaa](https://t.co/6UkxXNCvaa)
>
> Andrew Culver (@andrewculver) [December 13, 2020](https://twitter.com/andrewculver/status/1338189146213543951?ref_src=twsrc%5Etfw)
