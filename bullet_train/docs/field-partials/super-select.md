Note: before you attempt to manually wire up a `super_select` field, note that Super Scaffolding will automatically do that for your models. See [Super Scaffolding](../super-scaffolding.md), docs, section 5, for an example. And make sure Super Scaffolding doesn't automatically do what you're trying to do.
...
For an example of catching the `$change` event to update a dependent field, look at the [Dynamic Forms and Dependent Fields](dynamic-forms-dependent-fields.md) doc.
...
See [Dynamic Forms and Dependent Fields](dynamic-forms-dependent-fields.md).
