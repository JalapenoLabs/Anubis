...
* [Use the GitHub Action we provide to create an upgrade Pull Request](upgrades.md#github-action)
* [Performa a manual upgrade via git](upgrades.md#manual-upgrade)
...
[Be sure to check our Notable Versions list to see if there's anything tricky about the version you're moving to.](upgrades/notable-versions.md)
